...
Tą epoką rządzi wiecznie tląca się krew lewiatanów - źródło energii wynikającej z cierpienia istot po drugiej stronie tafli. Nienaturalny byt zostaje okiełznany przez pazernego ducha biznesu. Mieszkańcy starają się wiązać koniec z końcem, nie wiedząc przy tym czy ufać dawno utartym gusłom, czy też szansie którą daje nieograniczony prawem postęp.
...
| **Szajki**              | Szajka graczy. Stanowią wszystkie ugrupowania, które są tworzone i rozgrywane przez Graczy.                                                                     |
| **Sesje**               | Podsumowania z sesji w Kampanii. Stanowią transkrypcję wydarzeń, które mają miejsce w trakcie poszczególnych sesji.                                             |
